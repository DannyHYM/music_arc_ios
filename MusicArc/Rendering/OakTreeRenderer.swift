...
struct OakTreeRenderer: TreeRenderer {
    func draw(in context: GraphicsContext, size: CGSize, growth: Double, health: Double) {
        ...
        if g < 0.05 {
            ...
            drawRoots(context: context, cx: cx, baseY: baseY, w: w, g: g)
            drawTrunk(context: context, cx: cx, baseY: baseY, w: w, h: h, g: g)
            drawCanopy(context: context, cx: cx, baseY: baseY, w: w, h: h, g: g, hp: hp)
            if g >= 0.92 {
                drawFruits(context: context, cx: cx, baseY: baseY, w: w, h: h, g: g)
            }
        }
    }
    ...
    private func drawCanopy(context: GraphicsContext, cx: CGFloat, baseY: CGFloat, w: CGFloat, h: CGFloat, g: Double, hp: Double) {
        let t = CGFloat((g - 0.20) / 0.80)
    ...
    private func drawRoots(context: GraphicsContext, cx: CGFloat, baseY: CGFloat, w: CGFloat, g: Double) {
    ...
    private func drawFruits(context: GraphicsContext, cx: CGFloat, baseY: CGFloat, w: CGFloat, h: CGFloat, g: Double) {
        let t = CGFloat((g - 0.20) / 0.80)
        let trunkH = h * (0.18 + 0.38 * t)
        let topY = baseY - trunkH
        let maxR = w * 0.38
